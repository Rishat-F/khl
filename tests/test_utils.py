...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("В расстановке 'пять на три' не забили", "В расстановке '' не забили"),
        ("Комбинация при игре четыре на четыре", "Комбинация при игре "),
        ("'Три на четыре' было тяжело", "'' было тяжело"),
        ("ШЕСТЬ НА ШЕСТЬ - нонсенс", " - нонсенс"),
    ],
)
