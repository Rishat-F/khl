...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            marks=[pytest.mark.minor_bug, pytest.mark.xfail(reason="Minor bug")],
        ),
        ...
        pytest.param(
            "'Спартак' проиграл шведскому АИКу",
            ["org", "проиграть", "шведский", "org"],
            marks=pytest.mark.xfail(reason="Should be fixed after bug #14 fixing"),
        ),
...
def test_e2e_with_default_params():
    text = """
        1 апреля 2023 года в матче ⅛ финала против „Спартака” Иван Иванов забил свой 100—й гол за карьеру.
        «Динамо Мск» - «Спартак» 2:1 ОТ (1:0 0:1 0:0 1:0) Голы забили: Иванов, Петров, Сидоров.
